...
public class All_POM_TesT_files {
	...
	void testRegistration() throws InterruptedException
	{
		...
		ur.myAccount();
		ur.clickOnRegister();
		ur.firstName("Pavan Kumar");
		ur.lastName("Oggu");
		ur.email("pavankumaroggu@gmail.com");
		ur.tphone("9059007119");
		ur.entrPwd("Pavan@20");
		ur.entrCfrmPwd("Pavan@20");
		ur.subscribe();
		ur.AgreeCheckbox();
		ur.clickContinue();
		Thread.sleep(2000);
	...
	void testLogin() throws InterruptedException
	{
		...
		login.myAccount();
		login.clickOnLogin();
		login.enterEmail("pavankumaroggu@gmail.com");
		login.enterPwd("Pavan@20");
		login.login();
	...
	public void testLoginWithInvalidCredentials() throws InterruptedException
	{
		...
		login.myAccount();
		login.clickOnLogin();
		login.enterEmail("pavan123@gmail.com");
		login.enterPwd("Pavan");
		login.login(); 
	    Thread.sleep(5000);
	}
